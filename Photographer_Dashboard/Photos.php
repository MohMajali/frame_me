...
if (!$P_ID) {
    ...
    if (isset($_POST['Submit'])) {
        ...
        $stmt->bind_param("iis", $category_id, $photographer_id, $image);
        ...
        if ($stmt->execute()) {
            ...
            echo "<script language='JavaScript'>
                alert ('Picture Has Been Updated Successfully !');
           </script>";
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title">Picture Information</h5>
                <button
                  type="button"
                  class="btn-close"
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                  ...
                  <tbody>
<?php
$sql1 = mysqli_query($con, "SELECT * from photographer_pictures WHERE photographer_id = '$P_ID' ORDER BY id DESC");
