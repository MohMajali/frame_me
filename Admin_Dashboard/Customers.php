            ...
            <div class="card">
              <div class="card-body">
                ...
                <table class="table datatable">
                  ...
                  <tbody>
<?php
$sql1 = mysqli_query($con, "SELECT * from users WHERE user_type_id = 3 ORDER BY id DESC");

while ($row1 = mysqli_fetch_array($sql1)) {

    $customer_id = $row1['id'];
    $customer_image = $row1['image'];
    $customer_name = $row1['name'];
    $customer_email = $row1['email'];
    $customer_phone = $row1['phone'];
    $active = $row1['active'];
                    ...
                    <tr>
                      ...
                      <td>
                          ...
                          <?php if ($active == 1) {?>
                            ...
                            <a href="./DeleteOrRestoreUser.php?user_id=<?php echo $customer_id ?>&&isActive=<?php echo 0 ?>&isCustomer=1" class="btn btn-danger">Delete</a>

                            <?php } else {?>

                              <a href="./DeleteOrRestoreUser.php?user_id=<?php echo $customer_id ?>&&isActive=<?php echo 1 ?>&isCustomer=1" class="btn btn-primary">Restore</a>
