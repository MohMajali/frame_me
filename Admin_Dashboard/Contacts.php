            ...
            <div class="card">
              <div class="card-body">
                ...
                <table class="table datatable">
                  ...
                  <tbody>
<?php
$sql1 = mysqli_query($con, "SELECT * from contact_us ORDER BY id DESC");
...
while ($row1 = mysqli_fetch_array($sql1)) {
    ...
    ?>
                    <tr>
                      ...
                      <td>
                      <button onclick="onClick(event)" type="button" id="button-<?php echo $message ?>" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#verticalycentered">View Message</button>
