...
if (!$A_ID) {
    ...
    if (isset($_POST['Submit'])) {
        ...
        $stmt = $con->prepare("INSERT INTO categories (category, image) VALUES (?, ?) ");

        $stmt->bind_param("ss", $categoryName, $image);
...
<html lang="en">
  <head>
    ...
    <title>Categories - FrameMe</title>
...
while ($row1 = mysqli_fetch_array($sql1)) {
    ...
    ?>
                    <tr>
                      ...
                      <th scope="row">
                        <img src="<?php echo $category_image?>" alt="" width="150px" height="150px">
                      </th>
